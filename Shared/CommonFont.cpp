...
const XMFLOAT2 CommonFont::Style::DEFAULT_SCALE(1.f, 1.f);
...
CommonFont::Style::Style(const VertexColour &colourArg, const XMFLOAT2 &scaleArg):
scale(scaleArg),
colour(colourArg)
{
}
...
void CommonFont::DrawString(const XMFLOAT3 &startPos, const Style *pStyle, const char *pStr)
{
	HRESULT hr;
...
void CommonFont::DrawStringf(const XMFLOAT3 &pos, const Style *pStyle, const char *pFmt, ...)
{
	char aStr[1000];
